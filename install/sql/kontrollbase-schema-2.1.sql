...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='data updated daily by kontroll-overview_daily.pl script';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `analytics_overview_data`
--

LOCK TABLES `analytics_overview_data` WRITE;
/*!40000 ALTER TABLE `analytics_overview_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `analytics_overview_data` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `server_list` (
  ...
  `server_mysql_socket` varchar(255) NOT NULL DEFAULT '/var/lib/mysql/mysql.sock',
...
INSERT INTO `server_list` (`id`, `active`, `server_client_id`, `server_type`, `server_is_slave`, `server_ipaddress`, `server_hostname`, `server_ssh_user`, `server_mysql_port`, `server_mysql_socket`, `server_mysql_db`, `server_mysql_user`, `server_mysql_pass`, `server_mysql_host`, `server_snmp_local_address`, `server_snmp_port`, `server_snmp_rocommunity`, `server_snmp_version`, `threshold_queries_per_second`, `threshold_seconds_behind_master`, `creation_time`) VALUES (12,1,6,0,1,'192.168.0.20','node0','kontrollbase',3306,'/var/lib/mysql/mysql.sock','mysql','kontrollbase','password','localhost','127.0.0.1',161,'public','1',1000,3600,'2009-02-18 13:05:06');
...
CREATE TABLE `server_statistics` (
  ...
  `os_mem_total` bigint(128) unsigned NOT NULL,
  `os_mem_used` bigint(128) unsigned NOT NULL,
  `os_swap_total` bigint(128) unsigned NOT NULL,
  `os_swap_free` bigint(128) unsigned NOT NULL,
  ...
  `length_data` bigint(128) unsigned NOT NULL,
  `length_index` bigint(128) unsigned NOT NULL,
  `engine_count_innodb` int(16) NOT NULL,
  `engine_count_myisam` int(16) NOT NULL,
  `engine_myisam_size_data` bigint(128) unsigned NOT NULL,
  `engine_myisam_size_index` bigint(128) unsigned NOT NULL,
  `engine_innodb_size_data` bigint(128) unsigned NOT NULL,
  `engine_innodb_size_index` bigint(128) unsigned NOT NULL,
  `auto_increment_increment` bigint(128) unsigned NOT NULL,
  `auto_increment_offset` bigint(128) unsigned NOT NULL,
  `automatic_sp_privileges` char(4) NOT NULL,
  `back_log` bigint(128) unsigned NOT NULL,
  `basedir` char(16) NOT NULL,
  `binlog_cache_size` bigint(128) unsigned NOT NULL,
  `bulk_insert_buffer_size` bigint(128) unsigned NOT NULL,
  ...
  `completion_type` bigint(128) unsigned NOT NULL,
  `concurrent_insert` bigint(128) unsigned NOT NULL,
  `connect_timeout` bigint(128) unsigned NOT NULL,
  `datadir` varchar(255) NOT NULL,
  `date_format` varchar(128) NOT NULL,
  `datetime_format` varchar(128) DEFAULT NULL,
  `default_week_format` bigint(128) unsigned NOT NULL,
  `delay_key_write` char(8) NOT NULL,
  `delayed_insert_limit` bigint(128) unsigned NOT NULL,
  `delayed_insert_timeout` bigint(128) unsigned NOT NULL,
  `delayed_queue_size` bigint(128) unsigned NOT NULL,
  `div_precision_increment` bigint(128) unsigned NOT NULL,
  `keep_files_on_create` char(8) NOT NULL,
  `engine_condition_pushdown` char(8) NOT NULL,
  `expire_logs_days` bigint(128) unsigned NOT NULL,
  `flush` char(8) NOT NULL,
  `flush_time` bigint(128) unsigned NOT NULL,
  `ft_boolean_syntax` varchar(64) NOT NULL,
  `ft_max_word_len` bigint(128) unsigned NOT NULL,
  `ft_min_word_len` bigint(128) unsigned NOT NULL,
  `ft_query_expansion_limit` bigint(128) unsigned NOT NULL,
  `ft_stopword_file` char(64) NOT NULL,
  `group_concat_max_len` bigint(128) unsigned NOT NULL,
  ...
  `innodb_additional_mem_pool_size` bigint(128) unsigned NOT NULL,
  `innodb_autoextend_increment` bigint(128) unsigned NOT NULL,
  `innodb_buffer_pool_awe_mem_mb` bigint(128) unsigned NOT NULL,
  `innodb_buffer_pool_size` bigint(128) unsigned NOT NULL,
  `innodb_checksums` char(8) NOT NULL,
  `innodb_commit_concurrency` bigint(128) unsigned NOT NULL,
  `innodb_concurrency_tickets` bigint(128) unsigned NOT NULL,
  ...
  `innodb_fast_shutdown` bigint(128) unsigned NOT NULL,
  `innodb_file_io_threads` bigint(128) unsigned NOT NULL,
  ...
  `innodb_force_recovery` bigint(128) unsigned NOT NULL,
  `innodb_lock_wait_timeout` bigint(128) unsigned NOT NULL,
  `innodb_locks_unsafe_for_binlog` char(8) NOT NULL,
  `innodb_log_arch_dir` varchar(255) NOT NULL,
  `innodb_log_archive` char(8) NOT NULL,
  `innodb_log_buffer_size` bigint(128) unsigned NOT NULL,
  `innodb_log_file_size` bigint(128) unsigned NOT NULL,
  `innodb_log_files_in_group` bigint(128) unsigned NOT NULL,
  `innodb_log_group_home_dir` varchar(255) NOT NULL,
  `innodb_max_dirty_pages_pct` bigint(128) unsigned NOT NULL,
  `innodb_max_purge_lag` bigint(128) unsigned NOT NULL,
  `innodb_mirrored_log_groups` bigint(128) unsigned NOT NULL,
  `innodb_open_files` bigint(128) unsigned NOT NULL,
  `innodb_rollback_on_timeout` char(8) NOT NULL,
  `innodb_support_xa` char(8) NOT NULL,
  `innodb_sync_spin_loops` bigint(128) unsigned NOT NULL,
  `innodb_table_locks` char(8) NOT NULL,
  `innodb_thread_concurrency` bigint(128) unsigned NOT NULL,
  `innodb_thread_sleep_delay` bigint(128) unsigned NOT NULL,
  `innodb_read_ahead` bigint(128) unsigned NOT NULL,
  `innodb_ibuf_contract_const` bigint(128) unsigned NOT NULL,
  `innodb_ibuf_contract_burst` bigint(128) unsigned NOT NULL,
  `innodb_buf_flush_const` bigint(128) unsigned NOT NULL,
  `innodb_buf_flush_burst` bigint(128) unsigned NOT NULL,
  `interactive_timeout` bigint(128) unsigned NOT NULL,
  `join_buffer_size` bigint(128) unsigned NOT NULL,
  `key_buffer_size` bigint(128) unsigned NOT NULL,
  `key_cache_age_threshold` bigint(128) unsigned NOT NULL,
  `key_cache_block_size` bigint(128) unsigned NOT NULL,
  `key_cache_division_limit` bigint(128) unsigned NOT NULL,
  `language` varchar(255) NOT NULL,
  `large_files_support` char(8) NOT NULL,
  `large_page_size` bigint(128) unsigned NOT NULL,
  ...
  `log_warnings` bigint(128) unsigned NOT NULL,
  `long_query_time` bigint(128) unsigned NOT NULL,
  `low_priority_updates` char(8) NOT NULL,
  `lower_case_file_system` char(8) NOT NULL,
  `lower_case_table_names` bigint(128) unsigned NOT NULL,
  `max_allowed_packet` bigint(128) unsigned NOT NULL,
  `max_binlog_cache_size` bigint(128) unsigned NOT NULL,
  `max_binlog_size` bigint(128) unsigned NOT NULL,
  `max_connect_errors` bigint(128) unsigned NOT NULL,
  `max_connections` bigint(128) unsigned NOT NULL,
  `max_delayed_threads` bigint(128) unsigned NOT NULL,
  `max_error_count` bigint(128) unsigned NOT NULL,
  `max_heap_table_size` bigint(128) unsigned NOT NULL,
  `max_insert_delayed_threads` bigint(128) unsigned NOT NULL,
  `max_join_size` bigint(128) unsigned NOT NULL,
  `max_length_for_sort_data` bigint(128) unsigned NOT NULL,
  `max_prepared_stmt_count` bigint(128) unsigned NOT NULL,
  `max_relay_log_size` bigint(128) unsigned NOT NULL,
  `max_seeks_for_key` bigint(128) unsigned NOT NULL,
  `max_sort_length` bigint(128) unsigned NOT NULL,
  `max_sp_recursion_depth` bigint(128) unsigned NOT NULL,
  `max_tmp_tables` bigint(128) unsigned NOT NULL,
  `max_user_connections` bigint(128) unsigned NOT NULL,
  `max_write_lock_count` bigint(128) unsigned NOT NULL,
  `min_examined_row_limit` bigint(128) unsigned NOT NULL,
  `multi_range_count` bigint(128) unsigned NOT NULL,
  `myisam_data_pointer_size` bigint(128) unsigned NOT NULL,
  `myisam_max_sort_file_size` bigint(128) unsigned NOT NULL,
  `myisam_recover_options` char(32) NOT NULL,
  `myisam_repair_threads` bigint(128) unsigned NOT NULL,
  `myisam_sort_buffer_size` bigint(128) unsigned NOT NULL,
  `myisam_stats_method` char(32) NOT NULL,
  `net_buffer_length` bigint(128) unsigned NOT NULL,
  `net_read_timeout` bigint(128) unsigned NOT NULL,
  `net_retry_count` bigint(128) unsigned NOT NULL,
  `net_write_timeout` bigint(128) unsigned NOT NULL,
  `new` char(8) NOT NULL,
  `old_passwords` char(8) NOT NULL,
  `open_files_limit` bigint(128) unsigned NOT NULL,
  `optimizer_prune_level` bigint(128) unsigned NOT NULL,
  `optimizer_search_depth` bigint(128) unsigned NOT NULL,
  `pid_file` varchar(255) NOT NULL,
  `port` bigint(128) unsigned NOT NULL,
  `preload_buffer_size` bigint(128) unsigned NOT NULL,
  `protocol_version` bigint(128) unsigned NOT NULL,
  `query_alloc_block_size` bigint(128) unsigned NOT NULL,
  `query_cache_limit` bigint(128) unsigned NOT NULL,
  `query_cache_min_res_unit` bigint(128) unsigned NOT NULL,
  `query_cache_size` bigint(128) unsigned NOT NULL,
  `query_cache_type` char(8) NOT NULL,
  `query_cache_wlock_invalidate` char(8) NOT NULL,
  `query_prealloc_size` bigint(128) unsigned NOT NULL,
  `range_alloc_block_size` bigint(128) unsigned NOT NULL,
  `log_slow_rate_limit` bigint(128) unsigned NOT NULL,
  `read_buffer_size` bigint(128) unsigned NOT NULL,
  `read_only` char(8) NOT NULL,
  `read_rnd_buffer_size` bigint(128) unsigned NOT NULL,
  ...
  `relay_log_space_limit` bigint(128) unsigned NOT NULL,
  `rpl_recovery_rank` bigint(128) unsigned NOT NULL,
  `secure_auth` char(8) NOT NULL,
  `secure_file_priv` char(8) NOT NULL,
  `server_id` bigint(128) unsigned NOT NULL,
  ...
  `slave_net_timeout` bigint(128) unsigned NOT NULL,
  `slave_skip_errors` varchar(255) NOT NULL,
  `slave_transaction_retries` bigint(128) unsigned NOT NULL,
  `slow_launch_time` bigint(128) unsigned NOT NULL,
  `socket` varchar(255) NOT NULL,
  `sort_buffer_size` bigint(128) unsigned NOT NULL,
  ...
  `sync_binlog` bigint(128) unsigned NOT NULL,
  `sync_frm` char(8) NOT NULL,
  `system_time_zone` char(8) NOT NULL,
  `table_cache` bigint(128) unsigned NOT NULL,
  `table_lock_wait_timeout` bigint(128) unsigned NOT NULL,
  `table_type` char(32) NOT NULL,
  `thread_cache_size` bigint(128) unsigned NOT NULL,
  `thread_stack` bigint(128) unsigned NOT NULL,
  `time_format` varchar(32) NOT NULL,
  `time_zone` varchar(32) NOT NULL,
  `timed_mutexes` char(8) NOT NULL,
  `tmp_table_size` bigint(128) unsigned NOT NULL,
  `tmpdir` varchar(255) NOT NULL,
  `transaction_alloc_block_size` bigint(128) unsigned NOT NULL,
  `transaction_prealloc_size` bigint(128) unsigned NOT NULL,
  ...
  `wait_timeout` bigint(128) unsigned NOT NULL,
  `Aborted_clients` bigint(128) unsigned NOT NULL,
  `Aborted_connects` bigint(128) unsigned NOT NULL,
  `Binlog_cache_disk_use` bigint(128) unsigned NOT NULL,
  `Binlog_cache_use` bigint(128) unsigned NOT NULL,
  `Bytes_received` bigint(128) unsigned NOT NULL,
  `Bytes_sent` bigint(128) unsigned NOT NULL,
  `Com_admin_commands` bigint(128) unsigned NOT NULL,
  `Com_alter_db` bigint(128) unsigned NOT NULL,
  `Com_alter_table` bigint(128) unsigned NOT NULL,
  `Com_analyze` bigint(128) unsigned NOT NULL,
  `Com_backup_table` bigint(128) unsigned NOT NULL,
  `Com_begin` bigint(128) unsigned NOT NULL,
  `Com_call_procedure` bigint(128) unsigned NOT NULL,
  `Com_change_db` bigint(128) unsigned NOT NULL,
  `Com_change_master` bigint(128) unsigned NOT NULL,
  `Com_check` bigint(128) unsigned NOT NULL,
  `Com_checksum` bigint(128) unsigned NOT NULL,
  `Com_commit` bigint(128) unsigned NOT NULL,
  `Com_create_db` bigint(128) unsigned NOT NULL,
  `Com_create_function` bigint(128) unsigned NOT NULL,
  `Com_create_index` bigint(128) unsigned NOT NULL,
  `Com_create_table` bigint(128) unsigned NOT NULL,
  `Com_create_user` bigint(128) unsigned NOT NULL,
  `Com_dealloc_sql` bigint(128) unsigned NOT NULL,
  `Com_delete` bigint(128) unsigned NOT NULL,
  `Com_delete_multi` bigint(128) unsigned NOT NULL,
  `Com_do` bigint(128) unsigned NOT NULL,
  `Com_drop_db` bigint(128) unsigned NOT NULL,
  `Com_drop_function` bigint(128) unsigned NOT NULL,
  `Com_drop_index` bigint(128) unsigned NOT NULL,
  `Com_drop_table` bigint(128) unsigned NOT NULL,
  `Com_drop_user` bigint(128) unsigned NOT NULL,
  `Com_execute_sql` bigint(128) unsigned NOT NULL,
  `Com_flush` bigint(128) unsigned NOT NULL,
  `Com_grant` bigint(128) unsigned NOT NULL,
  `Com_ha_close` bigint(128) unsigned NOT NULL,
  `Com_ha_open` bigint(128) unsigned NOT NULL,
  `Com_ha_read` bigint(128) unsigned NOT NULL,
  `Com_help` bigint(128) unsigned NOT NULL,
  `Com_insert` bigint(128) unsigned NOT NULL,
  `Com_insert_select` bigint(128) unsigned NOT NULL,
  `Com_kill` bigint(128) unsigned NOT NULL,
  `Com_load` bigint(128) unsigned NOT NULL,
  `Com_load_master_data` bigint(128) unsigned NOT NULL,
  `Com_load_master_table` bigint(128) unsigned NOT NULL,
  `Com_lock_tables` bigint(128) unsigned NOT NULL,
  `Com_optimize` bigint(128) unsigned NOT NULL,
  `Com_preload_keys` bigint(128) unsigned NOT NULL,
  `Com_prepare_sql` bigint(128) unsigned NOT NULL,
  `Com_purge` bigint(128) unsigned NOT NULL,
  `Com_purge_before_date` bigint(128) unsigned NOT NULL,
  `Com_rename_table` bigint(128) unsigned NOT NULL,
  `Com_repair` bigint(128) unsigned NOT NULL,
  `Com_replace` bigint(128) unsigned NOT NULL,
  `Com_replace_select` bigint(128) unsigned NOT NULL,
  `Com_reset` bigint(128) unsigned NOT NULL,
  `Com_restore_table` bigint(128) unsigned NOT NULL,
  `Com_revoke` bigint(128) unsigned NOT NULL,
  `Com_revoke_all` bigint(128) unsigned NOT NULL,
  `Com_rollback` bigint(128) unsigned NOT NULL,
  `Com_savepoint` bigint(128) unsigned NOT NULL,
  `Com_select` bigint(128) unsigned NOT NULL,
  `Com_set_option` bigint(128) unsigned NOT NULL,
  `Com_show_binlog_events` bigint(128) unsigned NOT NULL,
  `Com_show_binlogs` bigint(128) unsigned NOT NULL,
  `Com_show_charsets` bigint(128) unsigned NOT NULL,
  `Com_show_collations` bigint(128) unsigned NOT NULL,
  `Com_show_column_types` bigint(128) unsigned NOT NULL,
  `Com_show_create_db` bigint(128) unsigned NOT NULL,
  `Com_show_create_table` bigint(128) unsigned NOT NULL,
  `Com_show_databases` bigint(128) unsigned NOT NULL,
  `Com_show_errors` bigint(128) unsigned NOT NULL,
  `Com_show_fields` bigint(128) unsigned NOT NULL,
  `Com_show_grants` bigint(128) unsigned NOT NULL,
  `Com_show_innodb_status` bigint(128) unsigned NOT NULL,
  `Com_show_keys` bigint(128) unsigned NOT NULL,
  `Com_show_logs` bigint(128) unsigned NOT NULL,
  `Com_show_master_status` bigint(128) unsigned NOT NULL,
  `Com_show_ndb_status` bigint(128) unsigned NOT NULL,
  `Com_show_new_master` bigint(128) unsigned NOT NULL,
  `Com_show_open_tables` bigint(128) unsigned NOT NULL,
  `Com_show_privileges` bigint(128) unsigned NOT NULL,
  `Com_show_processlist` bigint(128) unsigned NOT NULL,
  `Com_show_slave_hosts` bigint(128) unsigned NOT NULL,
  `Com_show_slave_status` bigint(128) unsigned NOT NULL,
  `Com_show_status` bigint(128) unsigned NOT NULL,
  `Com_show_storage_engines` bigint(128) unsigned NOT NULL,
  `Com_show_tables` bigint(128) unsigned NOT NULL,
  `Com_show_triggers` bigint(128) unsigned NOT NULL,
  `Com_show_variables` bigint(128) unsigned NOT NULL,
  `Com_show_warnings` bigint(128) unsigned NOT NULL,
  `Com_slave_start` bigint(128) unsigned NOT NULL,
  `Com_slave_stop` bigint(128) unsigned NOT NULL,
  `Com_stmt_close` bigint(128) unsigned NOT NULL,
  `Com_stmt_execute` bigint(128) unsigned NOT NULL,
  `Com_stmt_fetch` bigint(128) unsigned NOT NULL,
  `Com_stmt_prepare` bigint(128) unsigned NOT NULL,
  `Com_stmt_reset` bigint(128) unsigned NOT NULL,
  `Com_stmt_send_long_data` bigint(128) unsigned NOT NULL,
  `Com_truncate` bigint(128) unsigned NOT NULL,
  `Com_unlock_tables` bigint(128) unsigned NOT NULL,
  `Com_update` bigint(128) unsigned NOT NULL,
  `Com_update_multi` bigint(128) unsigned NOT NULL,
  `Com_xa_commit` bigint(128) unsigned NOT NULL,
  `Com_xa_end` bigint(128) unsigned NOT NULL,
  `Com_xa_prepare` bigint(128) unsigned NOT NULL,
  `Com_xa_recover` bigint(128) unsigned NOT NULL,
  `Com_xa_rollback` bigint(128) unsigned NOT NULL,
  `Com_xa_start` bigint(128) unsigned NOT NULL,
  `Compression` bigint(128) unsigned NOT NULL,
  `Connections` bigint(128) unsigned NOT NULL,
  `Created_tmp_disk_tables` bigint(128) unsigned NOT NULL,
  `Created_tmp_files` bigint(128) unsigned NOT NULL,
  `Created_tmp_tables` bigint(128) unsigned NOT NULL,
  `Delayed_errors` bigint(128) unsigned NOT NULL,
  `Delayed_insert_threads` bigint(128) unsigned NOT NULL,
  `Delayed_writes` bigint(128) unsigned NOT NULL,
  `Flush_commands` bigint(128) unsigned NOT NULL,
  `Handler_commit` bigint(128) unsigned NOT NULL,
  `Handler_delete` bigint(128) unsigned NOT NULL,
  `Handler_discover` bigint(128) unsigned NOT NULL,
  `Handler_prepare` bigint(128) unsigned NOT NULL,
  `Handler_read_first` bigint(128) unsigned NOT NULL,
  `Handler_read_key` bigint(128) unsigned NOT NULL,
  `Handler_read_next` bigint(128) unsigned NOT NULL,
  `Handler_read_prev` bigint(128) unsigned NOT NULL,
  `Handler_read_rnd` bigint(128) unsigned NOT NULL,
  `Handler_read_rnd_next` bigint(128) unsigned NOT NULL,
  `Handler_rollback` bigint(128) unsigned NOT NULL,
  `Handler_savepoint` bigint(128) unsigned NOT NULL,
  `Handler_savepoint_rollback` bigint(128) unsigned NOT NULL,
  `Handler_update` bigint(128) unsigned NOT NULL,
  `Handler_write` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_pages_data` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_pages_dirty` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_pages_flushed` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_pages_free` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_pages_misc` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_pages_total` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_read_ahead_rnd` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_read_ahead_seq` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_read_requests` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_reads` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_wait_free` bigint(128) unsigned NOT NULL,
  `Innodb_buffer_pool_write_requests` bigint(128) unsigned NOT NULL,
  `Innodb_data_fsyncs` bigint(128) unsigned NOT NULL,
  `Innodb_data_pending_fsyncs` bigint(128) unsigned NOT NULL,
  `Innodb_data_pending_reads` bigint(128) unsigned NOT NULL,
  `Innodb_data_pending_writes` bigint(128) unsigned NOT NULL,
  `Innodb_data_read` bigint(128) unsigned NOT NULL,
  `Innodb_data_reads` bigint(128) unsigned NOT NULL,
  `Innodb_data_writes` bigint(128) unsigned NOT NULL,
  `Innodb_data_written` bigint(128) unsigned NOT NULL,
  `Innodb_dblwr_pages_written` bigint(128) unsigned NOT NULL,
  `Innodb_dblwr_writes` bigint(128) unsigned NOT NULL,
  `Innodb_log_waits` bigint(128) unsigned NOT NULL,
  `Innodb_log_write_requests` bigint(128) unsigned NOT NULL,
  `Innodb_log_writes` bigint(128) unsigned NOT NULL,
  `Innodb_os_log_fsyncs` bigint(128) unsigned NOT NULL,
  `Innodb_os_log_pending_fsyncs` bigint(128) unsigned NOT NULL,
  `Innodb_os_log_pending_writes` bigint(128) unsigned NOT NULL,
  `Innodb_os_log_written` bigint(128) unsigned NOT NULL,
  `Innodb_page_size` bigint(128) unsigned NOT NULL,
  `Innodb_pages_created` bigint(128) unsigned NOT NULL,
  `Innodb_pages_read` bigint(128) unsigned NOT NULL,
  `Innodb_pages_written` bigint(128) unsigned NOT NULL,
  `Innodb_row_lock_current_waits` bigint(128) unsigned NOT NULL,
  `Innodb_row_lock_time` bigint(128) unsigned NOT NULL,
  `Innodb_row_lock_time_avg` bigint(128) unsigned NOT NULL,
  `Innodb_row_lock_time_max` bigint(128) unsigned NOT NULL,
  `Innodb_row_lock_waits` bigint(128) unsigned NOT NULL,
  `Innodb_rows_deleted` bigint(128) unsigned NOT NULL,
  `Innodb_rows_inserted` bigint(128) unsigned NOT NULL,
  `Innodb_rows_read` bigint(128) unsigned NOT NULL,
  `Innodb_rows_updated` bigint(128) unsigned NOT NULL,
  `Key_blocks_not_flushed` bigint(128) unsigned NOT NULL,
  `Key_blocks_unused` bigint(128) unsigned NOT NULL,
  `Key_blocks_used` bigint(128) unsigned NOT NULL,
  `Key_read_requests` bigint(128) unsigned NOT NULL,
  `Key_reads` bigint(128) unsigned NOT NULL,
  `Key_write_requests` bigint(128) unsigned NOT NULL,
  `Key_writes` bigint(128) unsigned NOT NULL,
  `Last_query_cost` float NOT NULL,
  `Max_used_connections` bigint(128) unsigned NOT NULL,
  `Not_flushed_delayed_rows` bigint(128) unsigned NOT NULL,
  `Open_files` bigint(128) unsigned NOT NULL,
  `Open_streams` bigint(128) unsigned NOT NULL,
  `Open_tables` bigint(128) unsigned NOT NULL,
  `Opened_tables` bigint(128) unsigned NOT NULL,
  `Prepared_stmt_count` bigint(128) unsigned NOT NULL,
  `Qcache_free_blocks` bigint(128) unsigned NOT NULL,
  `Qcache_free_memory` bigint(128) unsigned NOT NULL,
  `Qcache_hits` bigint(128) unsigned NOT NULL,
  `Qcache_inserts` bigint(128) unsigned NOT NULL,
  `Qcache_lowmem_prunes` bigint(128) unsigned NOT NULL,
  `Qcache_not_cached` bigint(128) unsigned NOT NULL,
  `Qcache_queries_in_cache` bigint(128) unsigned NOT NULL,
  `Qcache_total_blocks` bigint(128) unsigned NOT NULL,
  `Questions` bigint(128) unsigned NOT NULL,
  `Rpl_status` bigint(128) unsigned NOT NULL,
  `Select_full_join` bigint(128) unsigned NOT NULL,
  `Select_full_range_join` bigint(128) unsigned NOT NULL,
  `Select_range` bigint(128) unsigned NOT NULL,
  `Select_range_check` bigint(128) unsigned NOT NULL,
  `Select_scan` bigint(128) unsigned NOT NULL,
  `Slave_open_temp_tables` bigint(128) unsigned NOT NULL,
  `Slave_retried_transactions` bigint(128) unsigned NOT NULL,
  `Slave_running` bigint(128) unsigned NOT NULL,
  `Slow_launch_threads` bigint(128) unsigned NOT NULL,
  `Slow_queries` bigint(128) unsigned NOT NULL,
  `Sort_merge_passes` bigint(128) unsigned NOT NULL,
  `Sort_range` bigint(128) unsigned NOT NULL,
  `Sort_rows` bigint(128) unsigned NOT NULL,
  `Sort_scan` bigint(128) unsigned NOT NULL,
  `Table_locks_immediate` bigint(128) unsigned NOT NULL,
  `Table_locks_waited` bigint(128) unsigned NOT NULL,
  `Tc_log_max_pages_used` bigint(128) unsigned NOT NULL,
  `Tc_log_page_size` bigint(128) unsigned NOT NULL,
  `Tc_log_page_waits` bigint(128) unsigned NOT NULL,
  `Threads_cached` bigint(128) unsigned NOT NULL,
  `Threads_connected` bigint(128) unsigned NOT NULL,
  `Threads_created` bigint(128) unsigned NOT NULL,
  `Threads_running` bigint(128) unsigned NOT NULL,
  `Uptime` bigint(128) unsigned NOT NULL,
  ...
  `Seconds_Behind_Master` bigint(128) unsigned NOT NULL,
...
INSERT INTO `system_main` (`system_version`, `system_help_doc`, `system_alerts_email_template`, `system_owner_name`, `system_alerts_email`, `system_hostname`, `system_graph_animation_enable`, `system_server_loop_timeout`) VALUES ('2.0.1-GA','For help please go to http://kontrollsoft.com/kontrollbase/userguide/toc.php','============================================\r\n This is a Kontrollbase alert notiofication \r\n============================================\r\nState:       $alert_state\r\nCustomer:    $server_client_name\r\nCheck:       Kontrollbase -> MySQL Alert -> $hostname\r\nBegin Time:  $date\r\nMessage:\r\n$alert_name\r\n$alert_category\r\n$alert_description\r\n$alert_solution\r\n\r\nFor more information please read the following documentation\r\n$alert_links\r\n','Kontrollsoft','email@null.com','localhost.localdomain',0,10);
...
INSERT INTO `system_users` (`id`, `system_user_name`, `system_user_pass`, `system_user_email`, `server_client_id`, `role_tier`, `creation_time`, `system_user_last_login`) VALUES (9,'admin','5f4dcc3b5aa765d61d8327deb882cf99','admin@null.com',0,0,'2009-03-03 11:16:22','2009-09-06 21:00:25');
...
--
-- Temporary table structure for view `view_analytics_overview`
--

DROP TABLE IF EXISTS `view_analytics_overview`;
/*!50001 DROP VIEW IF EXISTS `view_analytics_overview`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `view_analytics_overview` (
  `max_os_mem_used` double,
  `min_os_mem_used` double,
  `avg_os_mem_used` double,
  `stdev_os_mem_used` double,
  `max_size` double,
  `min_size` double,
  `avg_size` double,
  `stdev_size` double,
  ...
  `avg_connections` decimal(14,4),
  `stdev_connections` double(26,4),
  `max_qps` float,
  `min_qps` float,
  `avg_qps` double,
  `stdev_qps` double
...
--
-- Final view structure for view `view_analytics_overview`
--

/*!50001 DROP TABLE IF EXISTS `view_analytics_overview`*/;
/*!50001 DROP VIEW IF EXISTS `view_analytics_overview`*/;
