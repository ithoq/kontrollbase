...
INSERT INTO `alerts_custom` VALUES (1,0,'this table is not currently in use',0,0,'2009-03-17 10:26:41','this table is not currently in use');
...
INSERT INTO `graphs_custom` VALUES (1,0,'this table is not in use currently','0','this table is not in use currently');
...
INSERT INTO `server_client` VALUES (6,'test','test@test.com','000-000-0000','2009-03-29 15:18:46');
...
INSERT INTO `server_list` VALUES (12,1,6,0,1,'192.168.0.20','node0','kontrollbase',3306,'/var/lib/mysql/mysql.sock','mysql','kontrollbase','password','localhost','127.0.0.1',161,'public','1',1000,3600,'2009-02-18 13:05:06');
...
INSERT INTO `system_pages` VALUES (2,'host'),(3,'login'),(4,'main'),(5,'logout'),(6,'login-failed');
...
INSERT INTO `system_users` VALUES (9,'admin','5f4dcc3b5aa765d61d8327deb882cf99','admin@null.com',0,0,'2009-03-03 11:16:22',NULL);
...
-- Dump completed on 2009-09-02 16:52:54
