...
sub get_list {
    ...
    my $sql0 = "select t1.*,t2.id as server_client_id ,t2.server_client_name from server_list as t1, server_client as t2 where t1.active='0' and t1.server_client_id = t2.id order by id;";
