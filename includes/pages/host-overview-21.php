...
<tr><td class='td'><strong>MySQL version</strong>: </td><td class='td'><strong>Index size</strong>: 0 Bytes</td></tr>
<tr><td class='td'><strong>Default engine</strong>: </td><td class='td'><strong>Total size</strong>: 0 Bytes</td></tr>
<tr><td class='td'><strong>Uptime</strong>: 0 days</td><td class='td'><strong>InnoDB Tables</strong>: </td></tr>
<tr><td class='td'><strong>Avg Load</strong>: </td><td class='td'><strong>InnoDB Size</strong>: 0 Bytes</td></tr><tr><td class='td'><strong>Memory Used</strong>:  %</td><td class='td'><strong>MyISAM Tables</strong>: </td></tr><tr><td class='td'><strong>Memory Size</strong>: 0 Bytes</td><td class='td'><strong>MyISAM Size</strong>: 0 Bytes</td></tr><tr><td class='td'><strong>QPS</strong>: </td><td class='td'><strong>Collection Date</strong>: </td></tr><tr><td class='td'><strong>Connections</strong>: </td><td class='td'><strong>Polling time</strong>: </td></tr></div></table></td></tr><tr><td><table><tr><td colspan='4'><div id='content'><h1>Previous Week's Activity</h1></td></tr><tr><td>	<!-- START Code Block for Chart kontrollbase -->
