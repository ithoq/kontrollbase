...
$remove="'<a href=\"$nroot/index.php/alerts/remove/$alerts_current_id/$server_list_id/$alerts_def_id/$choice\" target=\"_self\"><img src=\"$nroot/includes/images/delete.gif\" width=\"12px\" height=\"12px\"></a>'";
  print "['$server_hostname','$alert_level','$alert_name',$remove]";
  $r++;
  if($r<$u) { print ",\n";} 
  else { 
    print "];\n\n";     
 ...
 print<<<HEAD
   ...
   { id: 'remove', header: "", width: 50, sortable: true, dataIndex: 'remove' }
   ],
   stripeRows: true,
