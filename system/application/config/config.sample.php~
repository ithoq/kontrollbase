...
$config['base_url']= "http://testing.kontrollbase.com/"; //USE TRAILING SLASH
$config['base_dir']     = "/var/www/html/kontrollbase-testing"; //NO TRAILING SLASH
...
$config['encryption_key'] = "bcf6ac7da2493874e398fb82e8a2ab44";
