...
<script type="text/javascript">
  Ext.onReady(function(){
		  ...
		  var connections = new Ext.FormPanel({ 
		    renderTo: document.body,
			buttonAlign: 'left',
			width:320,
			labelWidth:200,
		...
		var threads = new Ext.FormPanel({ 
		  ...
		  var tablelocking = new Ext.FormPanel({ 
		    renderTo: document.body,
			buttonAlign: 'left',
			width:320,
			labelWidth:200,
		  ...
		  var tablecache = new Ext.FormPanel({ 
		    renderTo: document.body,
			buttonAlign: 'left',
			width:320,
			labelWidth:200,
		  ...
		  var tmptables = new Ext.FormPanel({ 
		    renderTo: document.body,
			buttonAlign: 'left',
			width:320,
			labelWidth:200,
		  ...
		  var sortbuffer = new Ext.FormPanel({ 
		    renderTo: document.body,
			buttonAlign: 'left',
			width:320,
			labelWidth:200,
		  ...
		  var joinbuffer = new Ext.FormPanel({ 
		    renderTo: document.body,
			buttonAlign: 'left',
			width:320,
			labelWidth:200,
