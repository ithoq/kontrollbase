...
$config[\'schema_readonly_name\'] = "'.$MYSQL_R_DB.'"; // Schema name from database.php $db[\'read\'][\'database\'] 
$config[\'google_uacct\']= ""; // Set this if you want to use Google Analytics
...
$config[\'memcache_enabled\'] = FALSE; // Only set to TRUE if you honestly know what you are doing
