...
sub qcache_preload {
    ...
    my $sql0 = "select max(queries_per_second) as queries_per_second,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql1 = "select max(num_connections) as num_connections,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql2 = "select max(os_load_15) as os_load_15,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql3 = "select max(os_mem_used) as os_mem_used,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql4 = "select max(os_cpu_idle) as os_cpu_idle,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql5 = "select max(length_data) as length_data,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql6 = "select max(length_index) as length_index,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql7 = "select Bytes_received,Uptime,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
    my $sql8 = "select Bytes_sent,Uptime,DATE_FORMAT(Creation_time,'%m-%d %H:%i') as Date from server_statistics WHERE Creation_time BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY) GROUP BY DAY(Creation_time),HOUR(Creation_time) ORDER BY Creation_time";
